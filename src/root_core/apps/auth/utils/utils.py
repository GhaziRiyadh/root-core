...
# from root_core.apps.auth.routers.permission_router import get_permission_repository
from root_core.config import settings
from root_core.database import get_session
from root_core.exceptions import NotFoundException
...
async def get_user(username: Optional[str]) -> Optional[Any]:
    ...
    async with get_session() as session:
        ...
        result = await session.exec(
            ...
            .where(user_model.User.is_deleted == False)
