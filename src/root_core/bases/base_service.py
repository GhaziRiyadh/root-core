...
from root_core.response.schemas import PaginatedResponse
from root_core.schemas.fields import DynamicFormConfig, ModelDefinition
from root_core.services.field_service import FieldService
...
class BaseService(Generic[T]):
    ...
    async def _return_one_data(self, data):
        return data
